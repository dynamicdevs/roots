...
const Input = ({ placeholder, onKeyDown }:Props) => {
  ...
  return (
    <div className="
        px-2 lg:px-4 bg-primary-grey-600 h-8 lg:h-12 rounded w-full border-2 border-transparent
      focus-within:border-secondary-blue-500 hover:border-secondary-blue-500 transition-colors">
      <input 
        value={text} 
        type="text" 
