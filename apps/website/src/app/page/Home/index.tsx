  ...
  return (
    <GridWrapper className="bg-primary-grey-600 pb-4 md:pb-6 lg:pb-8">
      <div className="col-span-4 md:col-span-10 md:col-start-2 lg:col-span-6 lg:col-start-4 text-center">
        ...
        <h1 className="text-heading-06 md:text-heading-05 lg:text-heading-04 font-bold mt-2 md:mt-4 xl:mt-6 line-clamp-1">
          {data.title}
        </h1>
      ...
      <div
        className="col-span-4 md:col-span-10 md:col-start-2 lg:col-span-6 lg:col-start-4
          mt-4 md:mt-6 lg:mt-8"
      >
        <SubscribeBox />
      </div>
